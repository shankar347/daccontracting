...
function ApplicationForm({ job }) {
  ...
  if (sent) return <aside className="form-card success-state"><Check /><h2>Application prepared</h2><p>This frontend demonstration has not sent or stored your information. DAC can connect this form to a secure recruitment API later.</p><button className="button button-outline" onClick={() => setSent(false)}>Return to form</button></aside>
